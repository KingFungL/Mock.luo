;(function(factory) {
    ...
    editormd.defaults     = {
        ...
        width                : "100%",
        height               : "100%",
        path                 : "../Scripts/editor.md-master/lib/",       // Dependents module file directory
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            var appendElements = [
                (!settings.readOnly) ? "<i class=\"fa fa-close " + classPrefix + "preview-close-btn\"></i>" : "",
        ...
        createInfoDialog : function() {
            ...
            var infoDialogHTML = [
                ...
                "</div>",
                "<i class=\"fa fa-close " + classPrefix + "dialog-close\"></i>",
                "</div>"
            ].join("\n");
    ...
    editormd.createDialog = function(options) {
        ...
        if (options.closed)
        {
            html += "<i class=\"fa fa-close " + classPrefix + "dialog-close\"></i>";
        }
