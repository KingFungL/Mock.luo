...
namespace Mock.Code
{
    public interface IRedisHelper
    {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        Task<IEnumerable<string>> HashGetAsync(string redisKey, IEnumerable<string> hashFields, string value);
        ...
        /// <returns></returns>
        IEnumerable<string> ListRange(string redisKey, long start = 0, long stop = -1);
        ...
        /// <param name="stop"></param>
        /// <returns></returns>
        Task<IEnumerable<string>> ListRangeAsync(string redisKey, long start = 0, long stop = -1);
        ...
        /// <returns></returns>
        IEnumerable<string> SortedSetRangeByRank(string redisKey, long start = 0, long stop = -1, OrderType order = OrderType.Ascending);
